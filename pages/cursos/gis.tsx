...
const int2 = "🔮 Location data"
const int3 = "🎯 Interfaz de QGIS"
const int4 = "🚁 Insertar datos"
const int5 = "🧊 Edición básica"
const int6 = "🎞️ Geoprocesamiento"
const int7 = "🧑‍🤝‍🧑 Dónde encontrar datos abiertos"
const int8 = "⛰️ Crear mapas/exportar data"
const int9 = "🧾 Apuntes Finales"
const gishandler = "https://youtu.be/BeYA5Vi75Ck"
...
<MediaQuery smallerThan="sm" styles={{ display: 'none' }}>
    ...
    <Button.Group orientation="vertical">
      <Link href={'/cursos/gis#introduccion'}><Button variant="light" color="teal" fullWidth>{int1}</Button></Link>
      <Link href={'/cursos/gis#locationdata'}><Button variant="light" color="teal" fullWidth>{int2}</Button></Link>
      <Link href={'/cursos/gis#interfaz'}><Button variant="light" color="teal" fullWidth>{int3}</Button></Link>
      <Link href={'/cursos/gis#insertar'}><Button variant="light" color="teal" fullWidth>{int4}</Button></Link>
      <Link href={'/cursos/gis#edicion'}><Button variant="light" color="teal" fullWidth>{int5}</Button></Link>
      <Link href={'/cursos/gis#geoprocesamiento'}><Button variant="light" color="teal" fullWidth>{int6}</Button></Link>
      <Link href={'/cursos/gis#dondeencontrar'}><Button variant="light" color="teal" fullWidth>{int7}</Button></Link>
      <Link href={'/cursos/gis#crearmapas'}><Button variant="light" color="teal" fullWidth>{int8}</Button></Link>
      <Link href={'/cursos/gis#apuntesfinales'}><Button variant="light" color="teal" fullWidth>{int9}</Button></Link>
      </Button.Group>
      </Aside>
              </MediaQuery>
...
<Title id="locationdata" size="h2">{int2}</Title>
<Group grow align="center">
<ReactPlayer
        url={gishandler}
        controls
...
<Title id="interfaz" size="h2">{int3}</Title>
<Group grow align="center">
<ReactPlayer
        url={gishandler}
        controls
...
<Title id="insertar" size="h2">{int4}</Title>
<Group grow align="center">
<ReactPlayer
        url={gishandler}
        controls
...
<Title id="edicion" size="h2">{int5}</Title>
<Group grow align="center">
<ReactPlayer
        url={gishandler}
        controls
...
<Title id="geoprocesamiento" size="h2">{int6}</Title>
<Group grow align="center">
<ReactPlayer
        url={gishandler}
        controls
...
<Title id="dondeencontrar" size="h2">{int8}</Title>
<Group grow align="center">
<ReactPlayer
        url={gishandler}
        controls
...
<Title id="crearmapas" size="h2">{int7}</Title>
<Group grow align="center">
<ReactPlayer
        url={gishandler}
        controls
